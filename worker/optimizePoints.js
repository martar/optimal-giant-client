...
(function() {
  var PointTurns, PointsSet, evol, findCoords, gates_indices, gauss, solver, _,
  ...
  PointsSet = (function(_super) {
    ...
    function PointsSet(points, skier) {
      ...
      this.punishFuntion = __bind(this.punishFuntion, this);
    ...
    PointsSet.prototype.punishFuntion = function(angle) {
      if (angle <= 90) {
        return 0.01;
      } else {
    ...
    PointsSet.prototype.computePunishFactor = function(positions) {
      var a, abx, aby, angba, angbc, angle, angles, b, c, cbx, cby, i, punishFactors, rslt;
      i = 0;
      punishFactors = [];
      angles = [];
      ...
      while (i < positions.length - 2) {
        ...
        punishFactors.push(this.punishFuntion(angle));
        i += 1;
      }
      punishFactors.push(1);
    ...
    PointsSet.prototype.mySumPunishment = function() {
      var factor, index, nextPos, _i, _len, _ref;
      _ref = this.value;
      for (index = _i = 0, _len = _ref.length; _i < _len; index = ++_i) {
        nextPos = _ref[index];
        this.skier.moveStraightToPoint(1, nextPos, 0.001);
      }
      factor = this.computePunishment(this.value);
      return this.fitness = factor * this.skier.result;
    };

    PointsSet.prototype.decreaseVelocityPunishment = function() {
      var index, nextPos, punishFactors, _i, _len, _ref;
