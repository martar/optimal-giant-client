...
(function() {
  var B, Skier, Solver, Utils, alfa, cos, error, g, k1, lib, mag, pi, root, sin, sqrt, square,
    _this = this,
  ...
  Skier = (function() {
    ...
    */
    ...
    Skier.prototype.reset = function() {
      ...
      this.positions = [this.positions[this.positions.length - 1]];
    ...
    */
    ...
    Skier.prototype.moveStraightToPoint = function(punishFactor, endPoint, accuracy, sign_omega) {
      var kappa, reachedDestination, v, v_len, _results;
      if (accuracy == null) {
        accuracy = 0.01;
      }
      if (sign_omega == null) {
      ...
      _results = [];
      while (!reachedDestination) {
        v = Utils.findCoords(endPoint, this.positions[0], v_len);
        reachedDestination = this._moveWithArbitraryV(v, kappa, endPoint, accuracy, sign_omega);
        v_len = Utils.vectorLength(this.velocities[0]);
        _results.push(reachedDestination);
      }
      return _results;
    };
