  ...
  */
  ...
  module.exports = HomePageView = (function(_super) {
    ...
    HomePageView.prototype.onSuccess = function(result) {
      ...
      this.bestWeHave.html(this.problem.attributes.bestTimeInDb);
      return this.work();
    };
    ...
    HomePageView.prototype.afterRender = function() {
      ...
      this.currentlyYouFound = this.$('#currentlyYouFound');
      this.numberOfSolved = 0;
      this.computationContainer = this.$('#computation');
      this.game = $('<iframe id="game" width="100%" height="600px" src="http://uploads.ungrounded.net/473000/473755_skifree.swf"></iframe>');
      this.musicoff = this.$('#musicoff');
      this.musicoff.hide();
      this.musicoff.click(function() {
        _this.$('#game').remove();
        _this.musicoff.hide();
        return _this.musicon.show();
      });
      this.musicon = this.$('#musicon');
      this.musicon.click(function() {
        _this.computationContainer.append(_this.game);
        _this.musicon.hide();
        return _this.musicoff.show();
      });
    ...
    HomePageView.prototype.work = function() {
      ...
      this.worker.onmessage = function(event) {
        ...
        if (event.data.type === 'intermediate') {
          ...
          _this.currentlyYouFound.html(event.data.currentResult);
        }
