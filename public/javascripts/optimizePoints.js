  ...
  */
  ...
  PointsSet = (function(_super) {
    ...
    PointsSet.prototype.computeFitness = function() {
      ...
      t = 0;
      this.min = 100000;
      return this.decreaseVelocityPunishmentWithEgdeChangePunis();
    };
    ...
    PointsSet.prototype.decreaseVelocityPunishmentWithEgdeChangePunis = function() {
      ...
      return this.fitness = this.skier.result + computeRedundantEdgeChangePunish(result.numberOfEdgeChange, 5);
    };
    ...
    PointsSet.prototype.mutate = function(gaussAll, tau, tau_prim) {
      var c, diff, gauss, i, newValue, old_value, point, _i, _len;
      newValue = (function() {
